// Colors library - migrated from _deprecated/lib/colors.js
// Removed chroma-js dependency - only pure JS functions used by 4K page
...
function hexToParts(hex) {
  // Handle both "#abc123" and "abc123" formats
  if (hex.startsWith('#')) {
    hex = hex.slice(1);
  }
  var col = {
...
// Process color palettes on module load
